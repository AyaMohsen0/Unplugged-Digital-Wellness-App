...
The project addresses several modern digital wellness challenges including:
...
Unplugged combines:
- Offline challenges
- Social guilds and accountability groups
...
The project followed a full UX workflow including:
- Problem analysis
- User research
- Personas
- User journeys
...
- Handmade low-fidelity prototypes
- High-fidelity Figma prototype
- Complete onboarding and interaction flows
